...
\major{土木工程}
\supervisor{陈汉华}
\period{2000.12-2025.5}
\coverDate{2025年5月21日}

% 新版封面的背景图很大，有500多MB，可能会导致编译变慢
% 如果编译很慢，可以把下面这个命令的注释去掉，使用极致压缩后的封面背景图
% 注意：定稿时一定记得换回压缩前的封面图，压缩后的封面图会有画质损失的
% \useCompressedCoverBackground
